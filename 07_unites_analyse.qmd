...
if (file.exists("data/grille_mada_AP.rds")) {
  grille_mada_AP <- read_rds("data/grille_mada_AP.rds")
} else {
  ...
  # Helper function to safely extract the first element or return NA
  ...
  # Save the result
  write_rds(grille_mada_AP, "data/grille_mada_AP.rds")
}
