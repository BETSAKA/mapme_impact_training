...
if (file.exists("data/grille_mada_mapme.rds")) {
  load("data/grille_mada_mapme.rds")
} else {
  ...
  # # Create the GDAL config file
  # gdal_config_path <- "~/.gdal_config"
  # writeLines(c(
  #   "[.mapme-data]",
  #   paste0("path=", my_outdir), 
  #   paste0("AWS_SECRET_ACCESS_KEY=", Sys.getenv("AWS_SECRET_ACCESS_KEY")),
  #   paste0("AWS_ACCESS_KEY_ID=", Sys.getenv("AWS_ACCESS_KEY_ID"))), 
  #   gdal_config_path)
  # 
  # # Check and append GDAL_CONFIG_FILE to .Renviron if not already present
  # renviron_path <- "~/.Renviron"
  # gdal_config_line <- paste0("GDAL_CONFIG_FILE=", gdal_config_path)
  # if (file.exists(renviron_path)) {
  #   renviron_content <- readLines(renviron_path)
  #   if (!any(grepl(gdal_config_line, renviron_content))) {
  #     write(gdal_config_line, renviron_path, append = TRUE)
  #   }
  # } else {
  #   write(gdal_config_line, renviron_path)
  # }
